...
static const _Pulsa_type_support_symbol_names_t _Pulsa_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_pkg, msg, Pulsa)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_pkg, msg, Pulsa)),
  }
};
...
{
  return &::xicro_pkg::msg::rosidl_typesupport_cpp::Pulsa_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xicro_pkg, msg, Pulsa)() {
  return get_message_type_support_handle<xicro_pkg::msg::Pulsa>();
}
