...
static const _Pulse_type_support_symbol_names_t _Pulse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_pkg, msg, Pulse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_pkg, msg, Pulse)),
  }
};
...
{
  return &::xicro_pkg::msg::rosidl_typesupport_cpp::Pulse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xicro_pkg, msg, Pulse)() {
  return get_message_type_support_handle<xicro_pkg::msg::Pulse>();
}
