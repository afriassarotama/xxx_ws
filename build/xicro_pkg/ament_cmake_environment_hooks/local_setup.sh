...
: ${AMENT_CURRENT_PREFIX:="/home/twt4/xxx_ws/install/xicro_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xicro_pkg/environment/library_path.sh"
