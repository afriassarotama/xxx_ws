...
xicro_pkg__msg__Pulsa__create(void)
{
  ...
  xicro_pkg__msg__Pulsa * msg = (xicro_pkg__msg__Pulsa *)allocator.allocate(sizeof(xicro_pkg__msg__Pulsa), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xicro_pkg__msg__Pulsa));
  bool success = xicro_pkg__msg__Pulsa__init(msg);
  if (!success) {
...
xicro_pkg__msg__Pulsa__destroy(xicro_pkg__msg__Pulsa * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    xicro_pkg__msg__Pulsa__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
xicro_pkg__msg__Pulsa__Sequence__init(xicro_pkg__msg__Pulsa__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_pkg__msg__Pulsa * data = NULL;

  if (size) {
    data = (xicro_pkg__msg__Pulsa *)allocator.zero_allocate(size, sizeof(xicro_pkg__msg__Pulsa), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xicro_pkg__msg__Pulsa__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xicro_pkg__msg__Pulsa__fini(&data[i - 1]);
      }
...
xicro_pkg__msg__Pulsa__Sequence__fini(xicro_pkg__msg__Pulsa__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xicro_pkg__msg__Pulsa__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_pkg__msg__Pulsa__Sequence * array = (xicro_pkg__msg__Pulsa__Sequence *)allocator.allocate(sizeof(xicro_pkg__msg__Pulsa__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xicro_pkg__msg__Pulsa__Sequence__init(array, size);
  if (!success) {
...
xicro_pkg__msg__Pulsa__Sequence__destroy(xicro_pkg__msg__Pulsa__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xicro_pkg__msg__Pulsa__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xicro_pkg__msg__Pulsa__Sequence__are_equal(const xicro_pkg__msg__Pulsa__Sequence * lhs, const xicro_pkg__msg__Pulsa__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xicro_pkg__msg__Pulsa__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xicro_pkg__msg__Pulsa__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xicro_pkg__msg__Pulsa);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xicro_pkg__msg__Pulsa * data =
      (xicro_pkg__msg__Pulsa *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_pkg__msg__Pulsa__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xicro_pkg__msg__Pulsa__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xicro_pkg__msg__Pulsa__copy(
