...
class Init_Toggle_SendGoal_Event_response
{
public:
  explicit Init_Toggle_SendGoal_Event_response(::xicro_interfaces::action::Toggle_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::xicro_interfaces::action::Toggle_SendGoal_Event response(::xicro_interfaces::action::Toggle_SendGoal_Event::_response_type arg)
  {
...
private:
  ::xicro_interfaces::action::Toggle_SendGoal_Event msg_;
};

class Init_Toggle_SendGoal_Event_request
{
public:
  explicit Init_Toggle_SendGoal_Event_request(::xicro_interfaces::action::Toggle_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Toggle_SendGoal_Event_response request(::xicro_interfaces::action::Toggle_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Toggle_SendGoal_Event_response(msg_);
  }
...
class Init_Toggle_SendGoal_Event_info
{
public:
  Init_Toggle_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Toggle_SendGoal_Event_request info(::xicro_interfaces::action::Toggle_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Toggle_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::xicro_interfaces::action::Toggle_SendGoal_Event>()
{
  return xicro_interfaces::action::builder::Init_Toggle_SendGoal_Event_info();
}
...
class Init_Toggle_GetResult_Event_response
{
public:
  explicit Init_Toggle_GetResult_Event_response(::xicro_interfaces::action::Toggle_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::xicro_interfaces::action::Toggle_GetResult_Event response(::xicro_interfaces::action::Toggle_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::xicro_interfaces::action::Toggle_GetResult_Event msg_;
};

class Init_Toggle_GetResult_Event_request
{
public:
  explicit Init_Toggle_GetResult_Event_request(::xicro_interfaces::action::Toggle_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Toggle_GetResult_Event_response request(::xicro_interfaces::action::Toggle_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Toggle_GetResult_Event_response(msg_);
  }
...
class Init_Toggle_GetResult_Event_info
{
public:
  Init_Toggle_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Toggle_GetResult_Event_request info(::xicro_interfaces::action::Toggle_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Toggle_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::xicro_interfaces::action::Toggle_GetResult_Event>()
{
  return xicro_interfaces::action::builder::Init_Toggle_GetResult_Event_info();
}
