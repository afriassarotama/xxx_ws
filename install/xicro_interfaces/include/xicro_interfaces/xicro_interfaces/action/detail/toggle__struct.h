...
enum
{
  xicro_interfaces__action__Toggle_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xicro_interfaces__action__Toggle_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Toggle in the package xicro_interfaces.
typedef struct xicro_interfaces__action__Toggle_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xicro_interfaces__action__Toggle_SendGoal_Request__Sequence request;
  xicro_interfaces__action__Toggle_SendGoal_Response__Sequence response;
} xicro_interfaces__action__Toggle_SendGoal_Event;

// Struct for a sequence of xicro_interfaces__action__Toggle_SendGoal_Event.
typedef struct xicro_interfaces__action__Toggle_SendGoal_Event__Sequence
{
...
enum
{
  xicro_interfaces__action__Toggle_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xicro_interfaces__action__Toggle_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Toggle in the package xicro_interfaces.
typedef struct xicro_interfaces__action__Toggle_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xicro_interfaces__action__Toggle_GetResult_Request__Sequence request;
  xicro_interfaces__action__Toggle_GetResult_Response__Sequence response;
} xicro_interfaces__action__Toggle_GetResult_Event;

// Struct for a sequence of xicro_interfaces__action__Toggle_GetResult_Event.
typedef struct xicro_interfaces__action__Toggle_GetResult_Event__Sequence
{
