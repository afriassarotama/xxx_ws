...
def setup_var_protocol():
    ...
    return [4],['pulsa'],['std_msgs/UInt32.msg'],[['uint32']],[['data']],[[0]],[[1]],[[32]],[[4]]
...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_ctl')
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_ctl_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_ctl_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
