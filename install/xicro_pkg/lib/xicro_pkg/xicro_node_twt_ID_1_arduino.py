...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_twt')
...
class Subscriber_node(Node):
    def __init__(self,Obj_uart):
        super().__init__('xicro_subscriber_node_twt')
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        time.sleep(1)

        # gen sub
        #gen        self.subscription_hapus = self.create_subscription(UInt8,'hapus',self.callback_hapus,10)        self.callback_hapus
    # gen callback sub
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_twt_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_twt_'+str(sequence))        # gen Id mcu
        self.Idmcu = 1
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
