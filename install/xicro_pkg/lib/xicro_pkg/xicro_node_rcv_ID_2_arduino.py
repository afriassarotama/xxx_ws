...
class Publisher_node(Node):
    ...
    def __init__(self):
        super().__init__('xicro_publisher_node_rcv')
...
class Subscriber_node(Node):
    def __init__(self,Obj_uart):
        super().__init__('xicro_subscriber_node_rcv')
        self.Obj_uart = Obj_uart
        ...
        #gen
        self.subscription_hapus = self.create_subscription(Char,'hapus',self.callback_hapus,10)
        self.callback_hapus
...
class Srv_client_node(Node):
    def __init__(self,Obj_uart,OnIdsrv,Ongrab,sequence):
        super().__init__('xicro_service_client_node_rcv_'+str(sequence))        # gen Id mcu
        self.Idmcu = 2
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
...
class Action_client_node(Node):
    def __init__(self,Obj_uart,OnIdaction,Ongrab,sequence):
        super().__init__('xicro_action_client_node_rcv_'+str(sequence))        # gen Id mcu
        self.Idmcu = 2
        self.Obj_uart = Obj_uart
        self.xicro_instruction = Xicro_instruction(self.Obj_uart)
        self.Ongrab=Ongrab
